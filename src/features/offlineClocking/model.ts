...
function applyActivity(
  ...
  return {
    ...
    serviceId: payload.workType === 'job' ? payload.serviceId : undefined,
    serviceVisitId: payload.workType === 'job' ? payload.serviceVisitId : undefined,
...
export function buildEffectiveClockState(
  ...
  return {
    ...
    currentActivity: activeEntry ? {
      ...
      serviceName: activeEntry.serviceName,
      propertyName: activeEntry.propertyName,
